      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className={`w-full py-3 sm:py-4 rounded-xl font-black text-sm sm:text-base transition-all
              ${checkedBox
          ...
          >
            {loading ? (
              ...
              <span className="flex items-center justify-center gap-2">
                ...
                <span className="hidden sm:inline">Continue with Google (the real button)</span>
              </span>
            ) : (
              " Check the box first"
            )}
